...
export default {
  ...
  findById: async (req, res) => {
    try {
      ...
      const data = await CustomerMiddleware.findById({ shop, accessToken, id })
  ...
  update: async (req, res) => {
    try {
      ...
      const data = await CustomerMiddleware.update({
        shop,
        accessToken,
        id,
        data: req.body,
  ...
  delete: async (req, res) => {
    try {
      ...
      const data = await CustomerMiddleware.delete({ shop, accessToken, id })
